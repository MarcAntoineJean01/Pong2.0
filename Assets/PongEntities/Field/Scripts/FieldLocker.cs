...
public struct Field
{
    ...
    public Field(GameObject parent, Floor topFloor, Floor bottomFloor, Wall leftWall, Wall rightWall, Background background, Pad leftPad, Pad rightPad, BallEntity ball, SpikeStore spikeStore, DebuffStore debuffStore)
    {
        this.parent = parent;
