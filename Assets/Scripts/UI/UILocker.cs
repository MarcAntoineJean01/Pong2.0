...
namespace UiLocker
{
    ...
    public static class CubeRotationDirectory
    {
        ...
        {
            { Tuple.Create(0, 0), new int[4] {1, 5, 3, 4} },
            { Tuple.Create(0, 1), new int[4] {2, 5, 4, 0} },
            { Tuple.Create(0, 2), new int[4] {3, 5, 4, 1} },
            { Tuple.Create(0, 3), new int[4] {0, 5, 4, 2} },
            { Tuple.Create(0, 4), new int[4] {3, 2, 0, 1} },
            { Tuple.Create(0, 5), new int[4] {0, 1, 3, 2} },
            { Tuple.Create(90, 0), new int[4] {5, 3, 1, 4} },
            { Tuple.Create(90, 1), new int[4] {0, 5, 2, 4} },
            { Tuple.Create(90, 2), new int[4] {1, 5, 3, 4} },
            { Tuple.Create(90, 3), new int[4] {2, 5, 0, 4} },
            { Tuple.Create(90, 4), new int[4] {2, 1, 0, 3} },
            { Tuple.Create(90, 5), new int[4] {2, 1, 0, 3} },
            { Tuple.Create(180, 0), new int[4] {4, 3, 5, 1} },
            { Tuple.Create(180, 1), new int[4] {4, 0, 2, 5} },
            { Tuple.Create(180, 2), new int[4] {4, 1, 3, 5} },
            { Tuple.Create(180, 3), new int[4] {4, 2, 0, 5} },
            { Tuple.Create(180, 4), new int[4] {0, 1, 3, 2} },
            { Tuple.Create(180, 5), new int[4] {3, 2, 0, 1} },
            { Tuple.Create(270, 0), new int[4] {1, 4, 5, 3} },
            { Tuple.Create(270, 1), new int[4] {4, 2, 5, 0} },
            { Tuple.Create(270, 2), new int[4] {4, 3, 5, 1} },
            { Tuple.Create(270, 3), new int[4] {4, 0, 5, 2} },
            { Tuple.Create(270, 4), new int[4] {3, 0, 1, 2} },
            { Tuple.Create(270, 5), new int[4] {3, 0, 1, 2} },
        };
        ...
        {
            return new int [2] {NextPreviousFaceDict[key][2], NextPreviousFaceDict[key][3]};
        }
        public static int[] NextFaces(Tuple<int, int> key)
        {
            return new int [2] {NextPreviousFaceDict[key][0], NextPreviousFaceDict[key][1]};
        }
    }
}
