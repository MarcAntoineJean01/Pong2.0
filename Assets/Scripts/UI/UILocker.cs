...
namespace PongGame.UiLocker
{
    ...
    public static class CubeDirectory
    {
        ...
        {
            { Tuple.Create(0, 0), new[] {1, 5, 3, 4} },
            { Tuple.Create(0, 1), new[] {2, 5, 4, 0} },
            { Tuple.Create(0, 2), new[] {3, 5, 4, 1} },
            { Tuple.Create(0, 3), new[] {0, 5, 4, 2} },
            { Tuple.Create(0, 4), new[] {3, 2, 0, 1} },
            { Tuple.Create(0, 5), new[] {0, 1, 3, 2} },
            { Tuple.Create(90, 0), new[] {5, 3, 1, 4} },
            { Tuple.Create(90, 1), new[] {0, 5, 2, 4} },
            { Tuple.Create(90, 2), new[] {1, 5, 3, 4} },
            { Tuple.Create(90, 3), new[] {2, 5, 0, 4} },
            { Tuple.Create(90, 4), new[] {2, 1, 0, 3} },
            { Tuple.Create(90, 5), new[] {2, 1, 0, 3} },
            { Tuple.Create(180, 0), new[] {4, 3, 5, 1} },
            { Tuple.Create(180, 1), new[] {4, 0, 2, 5} },
            { Tuple.Create(180, 2), new[] {4, 1, 3, 5} },
            { Tuple.Create(180, 3), new[] {4, 2, 0, 5} },
            { Tuple.Create(180, 4), new[] {0, 1, 3, 2} },
            { Tuple.Create(180, 5), new[] {3, 2, 0, 1} },
            { Tuple.Create(270, 0), new[] {1, 4, 5, 3} },
            { Tuple.Create(270, 1), new[] {4, 2, 5, 0} },
            { Tuple.Create(270, 2), new[] {4, 3, 5, 1} },
            { Tuple.Create(270, 3), new[] {4, 0, 5, 2} },
            { Tuple.Create(270, 4), new[] {3, 0, 1, 2} },
            { Tuple.Create(270, 5), new[] {3, 0, 1, 2} },
        };
        ...
        {
            {0, new[]{
                    new CubesToHideFromFace(2, new[] {0,1,2,3}),
                    new CubesToHideFromFace(3, new[] {12,13,14,15}),
                    new CubesToHideFromFace(4, new[] {3,7,11,15}) ,
                    new CubesToHideFromFace(5, new[] {0,4,8,12})
                }
            },
            {1, new[]{
                    new CubesToHideFromFace(2, new[] {12,13,14,15}),
                    new CubesToHideFromFace(3, new[] {0,1,2,3}),
                    new CubesToHideFromFace(4, new[] {0,4,8,12}) ,
                    new CubesToHideFromFace(5, new[] {3,7,11,15})
                }
            },
            {2, new[]{
                    new CubesToHideFromFace(0, new[] {12,13,14,15}),
                    new CubesToHideFromFace(1, new[] {0,1,2,3}),
                    new CubesToHideFromFace(4, new[] {12,13,14,15}) ,
                    new CubesToHideFromFace(5, new[] {12,13,14,15})
                }
            },
            {3, new[]{
                    new CubesToHideFromFace(0, new[] {0,1,2,3}),
                    new CubesToHideFromFace(1, new[] {12,13,14,15}),
                    new CubesToHideFromFace(4, new[] {0,1,2,3}),
                    new CubesToHideFromFace(5, new[] {0,1,2,3})
                }
            },
            {4, new[]{
                    new CubesToHideFromFace(0, new[] {0,4,8,12}),
                    new CubesToHideFromFace(1, new[] {0,4,8,12}),
                    new CubesToHideFromFace(2, new[] {0,4,8,12}),
                    new CubesToHideFromFace(3, new[] {0,4,8,12})
                }
            },
            {5, new[]{
                    new CubesToHideFromFace(0, new[] {3,7,11,15}),
                    new CubesToHideFromFace(1, new[] {3,7,11,15}),
                    new CubesToHideFromFace(2, new[] {3,7,11,15}),
                    new CubesToHideFromFace(3, new[] {3,7,11,15})
                }
            }
        };
    }
