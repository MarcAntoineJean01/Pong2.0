...
namespace PongGame
{
    ...
    {
        public UnityEvent droppedAllCubeFragments = new();
        public UnityEvent droppedAllIcosahedronFragments = new();
        public UnityEvent droppedAllOctacontagonFragments = new();
