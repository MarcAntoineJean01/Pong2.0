...
public class Pad : PongEntity
{
    ...
    [SerializeField]
    protected PadConfirmEvent m_PadConfirm = new PadConfirmEvent();
    ...
    [SerializeField]
    protected PadPauseEvent m_PadPause = new PadPauseEvent();
    ...
    IEnumerator CycleAttractor()
    {
        ...
        Vector3 origin = new Vector3(sd == Side.Right ? transform.position.x - PongManager.sizes.padWidth * 0.5f : transform.position.x + PongManager.sizes.padWidth * 0.5f, transform.position.y, transform.position.z);
